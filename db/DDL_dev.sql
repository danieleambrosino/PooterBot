...
FOR EACH ROW
BEGIN
  INSERT INTO Chats (id, `type`) VALUES (NEW.chatId, 'private');
END;
...
FOR EACH ROW
BEGIN
  INSERT INTO Chats (id, `type`) VALUES (NEW.chatId, 'group');
END;
...
FOR EACH ROW
BEGIN
  INSERT INTO Chats (id, `type`) VALUES (NEW.chatId, 'supergroup');
END;
...
FOR EACH ROW
BEGIN
  INSERT INTO Chats (id, `type`) VALUES (NEW.chatId, 'channel');
END;
