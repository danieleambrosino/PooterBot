...
class TextResponder extends Responder
{
  ...
  private function evaluatePhrase()
  {
    ...
    elseif ( preg_match('/(pooter(?:bot)?[\w\s,\.]+)?(?:vaffanculo|hai (?:rot|scassa|sfracassa|scartavetra)to(?: (?:il cazzo|le palle|i coglioni))?|sei (?:inutile|un(?:o stronzo|a merda| coglione))|chi ti vuole|non capisci (?:un cazzo|niente)|che (?:cazzo )vuoi|falla finita)(?(1)|[\w\s,]+pooter(?:bot)?)|oh mostro/i',
                        $this->text) )
    {
