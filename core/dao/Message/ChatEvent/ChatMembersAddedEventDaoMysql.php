...
/**
 * Description of ChatMembersAddedEventDaoMysql
 *
 * @author Daniele Ambrosino
 */
class ChatMembersAddedEventDaoMysql extends ChatMembersAddedEventDao
{
  ...
  public function store($event)
  {
    ...
    $query = "INSERT IGNORE INTO Members (chatId, userId) VALUES ";
    $values = [];
